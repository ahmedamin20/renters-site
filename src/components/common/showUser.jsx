      ...
      <div className="min-w-[350px] my-3 mx-auto bg-itemsBgLight dark:bg-itemsBgDark rounded-lg overflow-hidden shadow-lg">
        <div className="border-b w-full">
          ...
          <div className="flex gap-2 p-2">
            ...
            <button className="flex-1 rounded-full border-2 border-gray-400 dark:border-gray-700 font-semibold text-black hover:bg-rose-600 hover:text-white dark:text-white px-4 py-2">
              Reject
            </button>
          </div>
        </div>
        <div className="px-4 py-4">
          <div className="flex gap-2 items-center text-gray-800 dark:text-gray-300 mb-4">
            under veiw just for test the rate and card footer
            <RateStar />
            <RateStar />
            <RateStar />
            <RateStar />
